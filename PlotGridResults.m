function PlotGridResults(grid, isStabilityAnalysis)
    ...
    if isStabilityAnalysis
        ...
        subplot(3, 2, 1)
        s1 = mesh(X, T, abs(grid.GroundTruthA), 'FaceAlpha', '0.1', 'edgecolor', 'k');
        s1.FaceColor = 'flat';
        set(s1, 'LineStyle', '-', 'LineWidth', 0.1);
        axis tight;
        ...
        subplot(3, 2, 2)
        s1 = mesh(X, T, abs(grid.GroundTruthB), 'FaceAlpha', '0.1', 'edgecolor', 'k');
        s1.FaceColor = 'flat';
        set(s1, 'LineStyle', '-', 'LineWidth', 0.1);
        ...
        subplot(3, 2, 5)
        s1 = mesh(X, T, abs(grid.PerturbedGridA), 'FaceAlpha', '0.1', 'edgecolor', 'k');
        s1.FaceColor = 'flat';
        set(s1, 'LineStyle', '-', 'LineWidth', 0.1);
        ...
        subplot(3, 2, 6)
        s1 = mesh(X, T, abs(grid.PerturbedGridB), 'FaceAlpha', '0.1', 'edgecolor', 'k');
        s1.FaceColor = 'flat';
        set(s1, 'LineStyle', '-', 'LineWidth', 0.1);
        ...
        subplot(3, 2, 3)
        s1 = mesh(X, T, abs(grid.InitialA), 'FaceAlpha', '0.1', 'edgecolor', 'k');
        s1.FaceColor = 'flat';
        set(s1, 'LineStyle', '-', 'LineWidth', 0.1);
        ...
        subplot(3, 2, 4)
        s1 = mesh(X, T, abs(grid.InitialB), 'FaceAlpha', '0.1', 'edgecolor', 'k');
        s1.FaceColor = 'flat';
        set(s1, 'LineStyle', '-', 'LineWidth', 0.1);
