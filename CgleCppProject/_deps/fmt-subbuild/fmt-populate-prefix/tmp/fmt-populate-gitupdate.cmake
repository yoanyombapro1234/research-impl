...
execute_process(
  COMMAND "/usr/local/bin/git" show-ref 7.1.3
  WORKING_DIRECTORY "/Users/yoanyomba/Desktop/CGLE/CgleCppProject/_deps/fmt-src"
...
# yet).
execute_process(
  COMMAND "/usr/local/bin/git" rev-list --max-count=1 7.1.3
  WORKING_DIRECTORY "/Users/yoanyomba/Desktop/CGLE/CgleCppProject/_deps/fmt-src"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/yoanyomba/Desktop/CGLE/CgleCppProject/_deps/fmt-src/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/yoanyomba/Desktop/CGLE/CgleCppProject/_deps/fmt-src/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
